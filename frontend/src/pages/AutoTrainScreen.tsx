        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-emerald-100 hover:bg-emerald-200 text-emerald-800 border border-emerald-300 rounded-xl text-sm font-semibold transition-all"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <select
                    className={`w-full border rounded-xl px-4 py-2.5 text-sm transition-all focus:outline-none focus:ring-2 appearance-none bg-white ${
          ...
          <div className="lg:col-span-2 space-y-6" ref={paramSectionRef}>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                {!jsonMode ? (
                  ...
                  <div>
                    <textarea
                      className={`w-full h-72 border rounded-xl px-4 py-3 font-mono text-xs leading-relaxed transition-all focus:outline-none focus:ring-2 ${
                        hasParamErrors()
            ...
            <div className="flex flex-col gap-3">
              <button
                className={`w-full py-4 rounded-xl font-semibold text-sm transition-all flex items-center justify-center gap-2 shadow-sm ${
                  activeJobCount >= 3
